...
(function(){
  ...
  const map = {
    portfolio:{title: 'Tu web profesional', icon:'¶', url: 'portfolio.miestudio.com', label: 'DESTINO ACTUAL · WEB'},
    instagram:{title: 'Tu red social favorita', icon:'@', url: 'instagram.com/aria.ink', label: 'DESTINO ACTUAL · RED SOCIAL'},
    video:{title: 'Un video privado', icon:'▶', url: 'dyn.tt/u/aria/baile-2026', label: 'DESTINO ACTUAL · VIDEO'},
    profile:{title: 'Tu página Dynamic', icon:'❍', url: 'dyn.tt/aria', label: 'DESTINO ACTUAL · PERFIL'},
  };
...
(function(){
  ...
  function updateDetail(zone){
    ...
    // prefer runtime translations if available via L(), fallback to initial zoneData
